...
class ExecutorchModel:
    ...
    def __call__(self, x, data=None):
        ...
        try:
            ...
            print("Tip: Ensure your Eval transforms output the EXACT static shape used during export.")
            raise e
        
        if len(outputs) == 1:
            return {'maps': outputs[0]} 
        else:
            # If your model exports multiple heads, you might need to map them manually.
            # Usually outputs[0] is the probability map.
            return {'maps': outputs[0]}
...
if __name__ == '__main__':
    ...
    config_path = "/scratch/penghao/OpenOCR/configs/det/dbnet/timm_real_repvit.yml" # Default
    #config_path = "/scratch/penghao/OpenOCR/configs/det/dbnet/timm_real_resnet50.yml" # Default
